...
void lePecas(FILE *arq, int *colunapecaatual, char ** pecaatual, int *movimentospecaatual){
    int i,j;
    char cache;
    //FILE *arq;
...
int main(){
    ...
    lePecas(arq, &colunapecaatual, pecaatual, &movimentospecaatual);
